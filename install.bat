...
REM leetcli Installation Script for Windows
REM This script builds and installs leetcli from source
...
REM Install to a local directory
echo 📥 Installing leetcli...
cmake --install build --prefix install

echo ✅ leetcli has been successfully built!
echo.
echo 🎉 The executable is located at: install\bin\leetcli.exe
echo.
echo 📝 To use leetcli from anywhere, add the following to your PATH:
echo    %cd%\install\bin
echo.
echo 📚 For more information, run: install\bin\leetcli.exe help
echo.
pause 